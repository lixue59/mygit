            ...
            <div class="content-second-table mt-20">
                <div class="content-second-table-top">
                    ...
                    <div  class="fr">
                        ...
                        <a class="order-detail"  href="front_orderAction_detailOrder?orderId=<%=fullOrdersList.get(i).getOrders().getId()%>">订单详情</a>
                    </div>
                    <div class="clear"></div>
                </div>
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                           <%=halfOrderextList.get(j).getOrderext().getNum() %>
                        </td>
                        <%if(j==0){ %>
                        ...
                        <%if(fullOrdersList.get(i).getOrders().getStatus()==2){%>
                            <button onclick="confirmOrder('<%=fullOrdersList.get(i).getOrders().getId() %>')">确认订单</button>
                         <%} %>
                        </td>
                        <%}else{ %>
...
function confirmOrder(id){
	if(confirm("确认要确认收货吗？")){
	window.location.href="front_orderAction_buyerupdateOrder?orders.status=3&orders.id="+id;
	}
}
</script>
